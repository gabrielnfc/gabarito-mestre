...
check "no-unfiltered-mass-mutation.js (idêntico nas duas versões) sem .bak" '[ ! -e "$R8/$GATES/eslint/no-unfiltered-mass-mutation.js.bak" ]'
check "no-unfiltered-mass-mutation.js entra no manifesto mesmo idêntico"  '[ -n "$(hash_no_manifesto "$R8" eslint/no-unfiltered-mass-mutation.js)" ]'
